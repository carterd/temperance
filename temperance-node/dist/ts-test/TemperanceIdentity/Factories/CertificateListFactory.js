...
const CertificateListFactory_1 = require("../../../ts-src/lib/TemperanceIdentity/Factories/CertificateListFactory");
...
describe('Class CertificateChainFactory', function () {
    describe('getCertificateChainAsync', function () {
        it('success', function (done) {
            var certificateChainFactory = new CertificateListFactory_1.default(validCertificateStore);
        ...
        it('failed with missing certificate', function (done) {
            var certificateChainFactory = new CertificateListFactory_1.default(missingCertificateStore);
            certificateChainFactory.logger = TestConfig_1.default.logger;
            certificateChainFactory.getCertificateListAsync(['one', 'two', 'three']).then((value) => {
